...
function BoostCaseStudy({ onClose }) {
  ...
  const researchCards = isEn ? [
    { icon: '👨‍👩‍👧', dato: 'Real interviews', desc: 'Seniors + direct caregivers' },
    ...
    { icon: '👨‍👩‍👧', dato: 'Entrevistas reales', desc: 'Adultos mayores + cuidadores directos' },
      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: mob ? '32px 16px 60px' : '56px 32px 80px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ marginBottom: '40px', backgroundColor: 'rgba(242,146,81,0.04)', border: '1px solid rgba(242,146,81,0.15)', borderRadius: '12px', padding: '28px' }}>
          ...
          <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.8)', lineHeight: 1.9, margin: '0 0 16px 0' }}>
            {isEn ? 'This project was born from a real need. I researched people with cognitive decline and their caregivers up close — which gave me access to experiences, frustrations and needs that no internet search can replicate. I interviewed them, observed their daily routine and understood first-hand how medication forgetting, appointment management and communication between caregivers are daily and critical problems.' : 'Este proyecto nació de una necesidad real. Investigué de cerca a personas con deterioro cognitivo y a sus cuidadores — lo que me dio acceso a experiencias, frustraciones y necesidades que ninguna búsqueda en internet puede replicar. Los entrevisté, observé su rutina diaria y entendí de primera mano cómo el olvido de medicación, la gestión de citas y la comunicación entre cuidadores son problemas cotidianos y críticos.'}
          </p>
          <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.8)', lineHeight: 1.9, margin: '0 0 16px 0' }}>
