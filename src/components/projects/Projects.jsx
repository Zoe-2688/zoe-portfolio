  ...
  return (
    <div
      ...
      style={{
        ...
        border: isFeatured
          ? `2px solid ${hovered ? 'rgba(0,212,255,0.9)' : 'rgba(0,212,255,0.55)'}`
          : `1px solid ${hovered ? 'rgba(0,212,255,0.5)' : 'rgba(0,212,255,0.15)'}`,
        boxShadow: isFeatured
          ? (hovered ? '0 0 0 1px rgba(0,212,255,0.3), 0 14px 48px rgba(0,212,255,0.28)' : '0 0 0 1px rgba(0,212,255,0.15), 0 8px 32px rgba(0,212,255,0.16)')
          : 'none',
  ...
  return (
    <section id="projects" className="bg-[#050d1a] py-24 px-6">
      ...
      >
        ...
        {/* Destacado — último proyecto, ancho completo */}
